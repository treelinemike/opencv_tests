...
class Uyvy10VideoFrame : public IDeckLinkVideoFrame
{
private:
	long					m_width;
	long					m_height;
...
public:
	Uyvy10VideoFrame(long width, long height, BMDFrameFlags flags);
	virtual ~Uyvy10VideoFrame() {};
	...
	virtual long			STDMETHODCALLTYPE	GetRowBytes(void) { return ((m_width + 47) / 48) * 128; };
